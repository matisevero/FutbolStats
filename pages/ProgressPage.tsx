...
const metricIcons: Record<GoalMetric, React.ReactNode> = {
  ...
  myAssists: <span style={{ fontSize: '1.sem' }}>👟</span>,
          ...
          <Card title="Constructor de metas inteligentes">
            <form onSubmit={handleAddGoal} style={styles.form}>
              ...
              {isPeriodSelectionVisible && (
                  <div style={styles.fieldGroup}>
                    <label style={styles.label}>3. Elige un período</label>
              ...
              <div style={styles.contextBox}>
                <strong>Contexto:</strong> Valor actual del período <strong>{historicalContext.currentValue.toFixed(['gpm', 'winRate', 'undefeatedRate'].includes(goalMetric) ? 2 : 0)}</strong> / Récord histórico <strong>{historicalContext.historicalBest.toFixed(['gpm', 'winRate', 'undefeatedRate'].includes(goalMetric) ? 2 : 0)}</strong>.
              </div>
                    ...
                    <Card>
                        ...
                        <section style={styles.section}>
                            ...
                            {!isGeneratingAdvice && (
                                ...
                                >
                                {matches.length < 5 ? 'Necesitas 5 partidos' : 'Generar nuevos desafíos'}
                                </button>
                            )}
