...
const SettingsPage: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    const headers = [
        "Fecha", "Resultado", "Mis Goles", "Mis Asistencias", "Dif. Gol", "Torneo", "Notas",
        "Mi Equipo", "Equipo Rival"
    ];
    
    const toCsvRow = (data: (string | number | undefined)[]) => {
  ...
  const handleResetData = () => {
    ...
    try {
      if (navigator.share && navigator.canShare(shareData)) {
        ...
        await navigator.clipboard.writeText(`${shareText} ${cleanAppUrl}`);
                        ...
                        <div style={{...styles.sectionContent, animation: 'fadeInDown 0.3s ease-out'}}>
                            <div style={styles.profileForm}>
                                ...
                                <button 
                                    ...
                                    style={{...styles.button, ...getPrimaryButtonStyle(theme.colors.accent1, hoveredButtons['saveProfile']), alignSelf: isDesktop ? 'flex-end' : 'stretch'}}
                ...
                <div style={styles.sectionContainer}>
                    ...
                    {expandedSection === 'data' && (
                        <div style={{...styles.sectionContent, animation: 'fadeInDown 0.3s ease-out'}}>
                            ...
                            <div style={{display: 'grid', gridTemplateColumns: isDesktop ? '1fr 1fr' : '1fr', gap: theme.spacing.medium}}>
                                <button 
                            ...
                            <div style={styles.csvInfo}>
                                ...
                                <ul style={styles.csvList}>
                                    <li><code>Fecha</code>: (Requerido) en formato AAAA-MM-DD.</li>
                                    <li><code>Resultado</code>: (Requerido) VICTORIA, DERROTA, o EMPATE.</li>
                                    <li><code>Mis Goles</code>: (Requerido) un número.</li>
                                    <li><code>Mis Asistencias</code>: (Requerido) un número.</li>
                                    <li><code>Dif. Gol</code>: (Opcional) número (positivo para victoria, negativo para derrota).</li>
                                    <li><code>Torneo</code>: (Opcional) el nombre del torneo.</li>
                                    <li><code>Notas</code>: (Opcional) notas sobre el partido.</li>
                                    <li><code>Mi Equipo</code>: (Opcional) nombres separados por punto y coma.</li>
                                    <li><code>Equipo Rival</code>: (Opcional) nombres separados por punto y coma.</li>
                                </ul>
                            </div>
                        </div>
                    )}
