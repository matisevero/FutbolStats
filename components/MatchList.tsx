...
// FIX: Import PlayerPerformance type to correct the onUpdateMatchPlayers prop type.
...
interface MatchListProps {
  ...
  // FIX: Changed string[] to PlayerPerformance[] to match the type expected by child components and provided by parent components.
...
const MatchList: React.FC<MatchListProps> = ({ matches, allMatches, allPlayers, onDeleteMatch, onEditMatch, onUpdateMatchPlayers, isReadOnly = false, sortBy }) => {
